        ...
        <div>
            <div
                ...
                <div
                    ...
                    <Link to="/journal">
                        <span className="inline-flex w-auto px-3 py-2 rounded hover:bg-tertiary cursor-pointer text-white">Journal</span>
                    </Link>

                    <Link to="/music">
                        <span className="inline-flex w-auto px-3 py-2 rounded hover:bg-tertiary cursor-pointer text-white">Music</span>
                    </Link>
                ...
                <div className="flex items-center space-x-5 md:flex">
                    <a
                        className="flex text-white cursor-pointer transition-colors duration-300">
                        <svg
                    ...
                    <a
                        className="flex text-white cursor-pointer transition-colors duration-300 font-semibold">
                        <svg
                            className="fill-current h-5 w-5 mr-2 mt-0.5"
                            xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink"
